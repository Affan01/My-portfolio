    ...
    <main className='container-page block relative  xl:max-w-[1280px] xl:m-28 xl:p-10 lg:max-w-[1024px] lg:m-20 bg-whh lg:p-10 40 70 60 rounded-[40px] md:max-w-f md:m-10 md:p-10 sm:max-w-full sm:bg-whh sm:m-0 sm:p-0'>
        ...
        <div className='flex flex-col lg:flex-row-reverse gap-6 mt-12 lg:mt-24 mb-16 lg:mb-28 xl:justify-center'>
            ...
            <div className='border-2 rounded-2xl bg-white p-6 w-full lg:w-72 h-auto lg:h-[400px]'>
                ...
                A serene and responsive yoga website designed to inspire mindfulness, offering personalized practice plans and a calming user experience.                </p>
                <div className='mt-6'> 
                    ...
                    <div className='flex flex-wrap gap-2 mt-3'>
                        ...
                        <span className='border-2 bg-whh p-1 text-xs'>SQL</span>
                    </div>
                </div>
            </div>
            {/* Swiper section */}
            <div className='w-full lg:w-[700px] h-auto '>
                <Swiper
                    ...
                    className="mySwiper"
                >
                    <SwiperSlide><img src='o1.png' className='w-full h-auto lg:h-[400px]' alt="Project Image 1"/></SwiperSlide>
                    <SwiperSlide><img src='o2.png' className='w-full h-auto lg:h-[400px]' alt="Project Image 1"/></SwiperSlide>
                    <SwiperSlide><img src='o3.png' className='w-full h-auto lg:h-[400px]' alt="Project Image 1"/></SwiperSlide>
                    <SwiperSlide><img src='o4.png' className='w-full h-auto lg:h-[400px]' alt="Project Image 1"/></SwiperSlide>
                    <SwiperSlide><img src='o5.png' className='w-full h-auto lg:h-[400px]' alt="Project Image 1"/></SwiperSlide>

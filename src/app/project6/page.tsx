    ...
    <main className='container-page block relative  xl:max-w-[1280px] xl:m-28 xl:p-10 lg:max-w-[1024px] lg:m-20 bg-whh lg:p-10 40 70 60 rounded-[40px] md:max-w-f md:m-10 md:p-10 sm:max-w-full sm:bg-whh sm:m-0 sm:p-0'>
        ...
        <div className='flex flex-col lg:flex-row-reverse gap-6 mt-12 lg:mt-24 mb-16 lg:mb-28 xl:justify-center'>
            ...
            <div className='border-2 rounded-2xl bg-white p-6 w-full lg:w-72 h-auto lg:h-[400px]'>
                ...
                An intelligent AI voice assistant offering seamless interaction through natural language processing, designed to simplify tasks and enhance user productivity.                </p>
                <div className='mt-6'> 
                    <h1 className='text-md font-bold'>Technology</h1>
                    <div className='flex flex-wrap gap-2 mt-3'>
                        <span className='border-2 bg-whh p-1 text-xs'>PyQt</span>
                        <span className='border-2 bg-whh p-1 text-xs'>Python</span>
                        <span className='border-2 bg-whh p-1 text-xs'>Qt Designer</span>
                        <span className='border-2 bg-whh p-1 text-xs'>Firebase</span>
                    </div>
                </div>
            </div>
            {/* Swiper section */}
            <div className='w-full lg:w-[700px] h-auto '>
                <Swiper
                    ...
                    className="mySwiper"
                >
                    <SwiperSlide><img src='ff1.png' className='w-full h-auto lg:h-[400px]' alt="Project Image 1"/></SwiperSlide>
                    <SwiperSlide><img src='ff2.png' className='w-full h-auto lg:h-[400px]' alt="Project Image 1"/></SwiperSlide>
                    <SwiperSlide><img src='ff3.png' className='w-full h-auto lg:h-[400px]' alt="Project Image 1"/></SwiperSlide>
                    <SwiperSlide><img src='ff4.png' className='w-full h-auto lg:h-[400px]' alt="Project Image 1"/></SwiperSlide>
                    <SwiperSlide><img src='ff5.png' className='w-full h-auto lg:h-[400px]' alt="Project Image 1"/></SwiperSlide>
                    <SwiperSlide><img src='ff6.png' className='w-full h-auto lg:h-[400px]' alt="Project Image 1"/></SwiperSlide>
